...
import 'package:wasftk/presentation/screens/bmi/card.dart';
          ...
          Padding(
            ...
            child: AppCard(
              ...
              child: Column(
                children: [
                  const SizedBox(height: 15),
                  Text('Height (in cm)', style: textTheme.bodySmall),
            ...
            children: [
              AppCard(
                child: Column(
                  children: [
                    const SizedBox(height: 15),
                    Text('Wieght', style: textTheme.bodySmall),
                    const SizedBox(height: 25),
                    Container(
                      height: 80,
                      width: 130,
                    ...
                    child: Center(
                      child: Column(
                        children: [
                          ...
                          Text(bmiResult(), style: textTheme.bodySmall),
                          const SizedBox(height: 20),
                          Text(
                            bmiFeedBack(),
